    ...
    <div class="min-h-screen bg-gradient-to-br from-[#0c1a3a] via-[#1e3a8a] via-[#1e40af] via-[#1d4ed8] to-[#3730a3] text-gray-900 font-sans pb-12">
        ...
        <header class="h-[66px] bg-white border-b-3 border-blue-600 px-[5%] md:px-[9%] flex items-center justify-between shadow-lg sticky top-0 z-50">
            ...
            <nav class="hidden md:flex items-center gap-[34px]">
                ...
                <Link :href="route('admin.users.index')" class="text-gray-600 hover:text-blue-600 text-sm font-semibold transition">User Management</Link>
                <Link :href="route('admin.subjects.index')" class="text-blue-600 font-bold text-sm py-6 relative after:content-[''] after:absolute after:left-0 after:bottom-[-3px] after:w-full after:h-[3px] after:bg-blue-600 after:rounded-t">
                    Subjects
                </Link>
            </nav>
