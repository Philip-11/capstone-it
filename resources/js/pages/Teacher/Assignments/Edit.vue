...
const props = defineProps({ assignment: Object, lessons: Array });

const form = useForm({
    title: props.assignment.title,
    lesson_id: props.assignment.lesson_id ?? '',
    instructions: props.assignment.instructions,
    max_points: props.assignment.max_points,
    due_date: props.assignment.due_date ? props.assignment.due_date.substring(0, 16) : ''
});
